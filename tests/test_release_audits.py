...
class PublicTreeAuditTest(unittest.TestCase):
    ...
    def test_ci_avoids_duplicate_branch_pushes_and_repeated_audits(self):
        ...
        self.assertIn("410c7e097c0a3e84a77d4bae2dc262324875b6ad", workflow)
        self.assertIn("--emotion-engine-source", workflow)
    ...
    def test_public_entrypoints_share_brand_and_receipt_contract(self):
        ...
        for document in (landing, chinese_landing):
            ...
            self.assertIn("python -m pip install packwright==0.3.4", document)
