...
ADAPTER_LAYOUTS = {
    ...
    "pi": {
        "display_name": "Pi",
        "entry": "AGENTS.md",
        "pack_kind": "PiAdapterPack",
        "skill_root": ".agents/skills",
        "skill_artifact": "{slug}-{skill_id}/SKILL.md",
        "legacy_skill_roots": (),
        "reference_root": ".pi/<slug>/references",
        "lifecycle": "project_context",
        "capabilities": ("local-files", "shell", "skills"),
        "guidance_kind": "skill",
        "emotion_engine_runtime": "unavailable_no_builtin_mcp",
    },
    "claude-code": {
