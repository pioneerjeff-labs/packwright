...
EMOTION_ENGINE_UPSTREAM_COMMIT = "48e6f3fff767209e3d96721935e5476734e740a4"
EMOTION_ENGINE_GENERATION = "2.0.0-rc.4-48e6f3f"
...
EMOTION_ENGINE_MIGRATION_LINEAGE_PATH = (
    ".packwright/transactions/emotion-engine-lineage.json"
)
