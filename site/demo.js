(() => {
  ...
  const englishLines = [
    { className: "cmd", text: "python -m pip install packwright==0.3.4" },
    { className: "t-ok", text: "  ✓ installed packwright 0.3.4 · Pi Core included" },
  ...
  const chineseLines = [
    { className: "cmd", text: "python -m pip install packwright==0.3.4" },
    { className: "t-ok", text: "  ✓ 已安装 packwright 0.3.4 · 已支持 Pi Core" },
    { className: "cmd", text: "packwright init --template code --name Nova -o work/nova" },
    { className: "cmd", text: "packwright build work/nova --adapter claude-code -o pack/nova-claude" },
